...
%
    \relatore{Prof.~\textsc{Lavagno} Luciano \small{(Politecnico di Torino)}}
    \secondorelatore{Prof.~\textsc{Moll Echeto} Francesc \footnotesize{(Universitat Politècnica \smallskip de Catalunya)}
    }
     
    \terzorelatore{Dr.~\textsc{Palomar} Oscar \small{(Barcelona Supercomputing Center)}}
% 
