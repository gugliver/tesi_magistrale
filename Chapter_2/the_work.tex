...
In Figure \ref{lb-genz} there is an example for the disposition of the elements of 64 bits. It is also important to say the number of bits for each element group stays the same, this means that the number of elements depends on the sew.\\
...
# Initializes 4 registers (256 elements of 64 bits each one)
...
The test is initialized with a macro, defining the sew = 32 and the size in bits = 512.\\
