...
\begin{table}[H]
    ...
    \hline
a\+mem\+sync\+end\+i & if mem\+sync\+end\+i is high, \\ & memop\+sb\+id\+i must be a known value \\\hline
...
a\+unique\+request & there can't be a request with the same sb\+id \\ &  of an inflight load\\\hline
    ...
    a\+load\+inflight & load\+inflight\+o is checked, \\ & it can be 1 when the number of load inflight is 1 or 2 and \\ & it can be 0 otherwise \\ \hline
    
    a\+load\+ready\+o & when load\+inflight\+o = 1 and lmu\+dvalid\+load\+i = 1, \\ & if there is fsm\+read\+en\+lbuf\+i, \\ & the next clock cycle there is load\+ready\+o = 1 \\ \hline
    
    a\+data\+corruption & check that each element that enter \\ & will eventually exit in correct position \\ \hline
